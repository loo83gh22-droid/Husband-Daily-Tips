...
-- ============================================================================
-- STEP 4: Remove Romance badges that don't fit the standard progression
-- ============================================================================

-- Remove "Romance Revivalist" at 10 actions (duplicate of "Romance Expert")
DELETE FROM badges 
WHERE name = 'Romance Revivalist'
AND requirement_value = 10
AND (category = 'Romance' OR name ILIKE '%romance%');

-- Remove ALL Romance category_count badges that don't match standard progression (1,5,10,25,50,100)
DELETE FROM badges 
...
-- ============================================================================
-- STEP 5: Remove Partnership badges that don't fit the standard progression
-- ============================================================================
