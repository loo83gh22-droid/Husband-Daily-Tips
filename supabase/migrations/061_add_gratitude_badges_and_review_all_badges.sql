...
SELECT * FROM (VALUES
  ('Gratitude Starter', 'Completed your first gratitude action. Appreciation starts here.', '🙏', 'big_idea', 'gratitude_actions', 1, 5, 'Gratitude'),
  ('Gratitude Builder', 'Completed 5 gratitude actions. You''re building a habit of appreciation.', '🙌', 'big_idea', 'gratitude_actions', 5, 15, 'Gratitude'),
  ('Gratitude Champion', 'Completed 10 gratitude actions. You''re consistently showing appreciation.', '🌟', 'big_idea', 'gratitude_actions', 10, 25, 'Gratitude'),
  ('Gratitude Master', 'Completed 25 gratitude actions. Gratitude is becoming second nature.', '✨', 'big_idea', 'gratitude_actions', 25, 40, 'Gratitude'),
  ('Gratitude Expert', 'Completed 50 gratitude actions. You''ve mastered the art of appreciation.', '💫', 'big_idea', 'gratitude_actions', 50, 60, 'Gratitude'),
  ('Gratitude Legend', 'Completed 100 gratitude actions. You''re a gratitude legend. She notices.', '👑', 'big_idea', 'gratitude_actions', 100, 100, 'Gratitude')
