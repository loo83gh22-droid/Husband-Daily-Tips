      ...
      <div className="flex flex-col md:flex-row items-center justify-between">
        <div className="mb-4 md:mb-0">
          ...
          <p className="text-primary-100">
            {message || 'Look at you. You\'re here. You\'re trying. That\'s what matters. Now unlock daily routine actions via email, weekly planning actions, weekly summary emails, full Husband Health tracking, badges, journal, and Team Wins. Try everything free for 7 days. No credit card. No BS.'}
          </p>
        </div>
        <Link
