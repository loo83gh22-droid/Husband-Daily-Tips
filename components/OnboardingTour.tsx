...
const TOUR_STEPS: TourStep[] = [
  {
    ...
    content: "This is your daily action. Complete it to boost your Husband Health. Each day you get a new action tailored to your situation.",
    position: 'bottom',
  },
  {
    id: 'hit-points',
    target: '[data-tour="hit-points"]',
    title: 'Husband Health',
