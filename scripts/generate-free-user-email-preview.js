/**
 * Generate a preview of the free user email template
 * Run: node scripts/generate-free-user-email-preview.js
 */
...
// Since we can't easily import ES modules in Node, we'll recreate the function inline
function generateFreeUserEmailHTML(tip, baseUrl) {
  return `
    <!DOCTYPE html>
    <html>
      <head>
...
// Sample email tip data
const sampleTip = {
  title: 'Leave Her a Love Note',
  content: `Write a short, genuine note telling her something you appreciate about her. Leave it somewhere she'll find it—her purse, her desk, or the bathroom mirror.

Why this matters: Small gestures of appreciation build connection and remind her she's seen and valued.`,
  category: 'Appreciation',
  quote: {
    quote_text: 'The little things? The little moments? They aren\'t little.',
...
// Generate the HTML
const emailHTML = generateFreeUserEmailHTML(sampleTip, baseUrl);

// Save to file
const outputPath = path.join(__dirname, 'free-user-email-preview.html');
fs.writeFileSync(outputPath, emailHTML, 'utf8');

console.log('✅ Free user email preview generated!');
