...
// Guide data organized by category (matching the dashboard how-to-guides page)
  ...
  'communication': {
    ...
    guides: [
      ...
      },
      {
        ...
        excerpt: 'Relationship researcher John Gottman found that healthy relationships need 5 positive interactions for every negative one. Learn how to build this ratio and rebuild connection.',
        difficulty: 'Medium',
        time: 'Ongoing',
      },
    ],
  ...
  'quality-time': {
    ...
    guides: [
      ...
      },
      {
        ...
        excerpt: 'Learn how to create a small daily ritual at the start of the day—morning coffee, walk, or check-in. Consistency builds connection.',
        difficulty: 'Easy',
        time: '10-30 min daily',
      },
      {
        ...
        excerpt: 'Learn how to create a small daily ritual at the end of the day—evening walk, bedtime check-in, or quiet time together.',
        difficulty: 'Easy',
        time: '10-30 min daily',
      },
      {
